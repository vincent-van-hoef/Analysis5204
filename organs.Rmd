...
```{r, echo = FALSE}
reg_plots <- list.files("~/Results/Plasma/Organ/general/regression_plots", full.names = TRUE, pattern = "*.pdf")
names(reg_plots) <- stringr::str_replace_all(reg_plots, 
                                      c("\\_regression.pdf" = "", 
                                        ".*/" = ""))
bsselect(reg_plots, type = "iframe", selected = "OSM", 
