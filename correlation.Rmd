...
create_crp_table <- function(source = "Plasma", marker = "crp", type = "GPA") {
  ...
  mutate("plot" = if(type == "GPA" | type == "MPA") { paste0('<a href ="./../Results/', source, '/Correlation/', marker, '/regression_plots/', Assay, '_GPA_MPA_regression.png"  target="_blank">', Assay, '</a>') } else { paste0('<a href ="./../Results/', source, '/Correlation/', marker, '/regression_plots/', Assay, '_MP_PR3_regression.png"  target="_blank">', Assay, '</a>')}) %>%
